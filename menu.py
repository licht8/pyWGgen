...
def manage_user_menu():
    """Запуск меню управления пользователями."""
    if not os.path.exists(CREATE_USER_SCRIPT):
        print(f"❌ Скрипт {CREATE_USER_SCRIPT} не найден.")
        return
...
def show_menu():
    ...
    while True:
        ...
        print("3. Управление сроками действия пользователей")
