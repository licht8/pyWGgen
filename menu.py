...
def show_main_menu():
    ...
    while True:
        ...
        print(f" aih. 🤖  Интерактивная помощь и диагностика (ai_help)")
        print(f" aid. 🤖  Интерактивная диагностика проекта (ai_diagnostics)")
        print(f"\n\t 0 или q. Выход")
        print(f" ==========================================\n")
        ...
        if choice == "i":
            ...
            print("🤖  Запуск справочной системы...")
            os.system("python3 ai_diagnostics/ai_help/ai_help.py")
        elif choice == "aid":
            print("🤖  Запуск интерактивной диагностики проекта...")
