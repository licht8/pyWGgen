...
<div style="border: 2px solid #ffcc00; border-radius: 5px; padding: 10px; background-color: #fff8e1; color: #333;">
    <strong>⚠️ Внимание!</strong><br>
    Этот проект находится в разработке и еще не готов к использованию. Пожалуйста, следите за обновлениями!
</div>
